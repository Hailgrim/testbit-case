...
const CellStyled = styled.div<{
  ...
  & > svg {
    ...
    margin-left: 1rem;
    flex-shrink: 0;
    transform: rotate(${props => props.$sortDirection === 'ASC' ? '0deg' : '180deg'});
    & path {
  ...
  &:hover {
    color: ${props => props.$sortable ? 'var(--color-white)' : 'var(--color-gray5)'};
    & > svg path {
      fill: ${props => props.$sortable ? 'var(--color-white)' : 'var(--color-gray5)'};
    }
  }
  ${theme.media.lg} {
    font-size: 1.4rem;
